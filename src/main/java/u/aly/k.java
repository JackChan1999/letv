...
public final class k implements p, w {
    ...
    public class a {
        ...
        protected void a(boolean z) {
            ...
            if (this.a.f.c()) {
                ...
                if (i == 0) {
                    if (z && this.a.h.a()) {
                        ...
                        bv.c("Debug: send log every 15 seconds");
            ...
            bv.c("Report policy : " + this.b.getClass().getSimpleName());
        }
    ...
    protected bp a(int... iArr) {
        ...
        try {
            if (TextUtils.isEmpty(AnalyticsConfig.getAppkey(this.o))) {
                bv.f("Appkey is missing ,Please check AndroidManifest.xml");
                return null;
            }
            byte[] e = h.a(this.o).e();
            ...
            if (bv.a && bpVar.B()) {
                ...
                if (obj == null) {
                    bv.e("missing Activities or PageViews");
                }
            }
