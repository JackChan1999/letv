...
*/
    ...
    public final void c() {
        ...
        this.a = a.b(byteBuffer);
        this.b = a.b(byteBuffer);
    }

    public final String toString() {
        return new StringBuilder(z[2]).append(this.a).append(z[1]).append(this.b).append(z[0]).append(super.toString()).toString();
    }
}
