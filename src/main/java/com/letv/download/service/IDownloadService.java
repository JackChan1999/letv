...
public interface IDownloadService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDownloadService {
        private static final String DESCRIPTOR = "com.letv.download.service.IDownloadService";
        static final int TRANSACTION_synRemoveDownload = 1;
    ...
    void synRemoveDownload(long j) throws RemoteException;
}
