            ...
            try {
                ...
                switch (from) {
                    ...
                    case FFMpegPlayer.PREPARE_VIDEO_NODECODER_ERROR /*260*/:
                        ...
                        album.extendSubscript = data.optString("extendSubscript");
                        album.leftSubscipt = data.optString("leftSubscipt");
                        album.leftSubsciptColor = data.optString("leftSubsciptColor");
                        album.subsciptColor = data.optString("subSciptColor");
                        return album;
                    case 272:
                    case 273:
                        album.isDolby = true;
                ...
                album.icon_16_9 = getString(getJSONObject(data, "images"), "pic169");
                ...
                album.noCopyright = TextUtils.equals(data.optString(PlayConstant.NO_COPYRIGHT), "1");
                album.externalUrl = data.optString("external_url");
                album.extendSubscript = data.optString("extendSubscript");
                album.leftSubscipt = data.optString("leftSubscipt");
                album.leftSubsciptColor = data.optString("leftSubsciptColor");
                album.subsciptColor = data.optString("subSciptColor");
