...
public class PreferencesManager {
    ...
    public boolean getUserPhoneNumberBindState() {
        boolean hasBinded = ((Boolean) SharedPreferenceUtils.get(context, SETTINGS, USER_PHONE_NUMBER_BIND_STATE, Boolean.valueOf(false))).booleanValue();
    ...
    public void setWebappVersion(String version) {
        SharedPreferenceUtils.put(context, HOME_PAGE, WEBAPP_VERSION, version);
    }
    ...
    public boolean isShowMyFavorite() {
        return ((Integer) SharedPreferenceUtils.get(context, SETTINGS, "isShowNewFeatures", Integer.valueOf(-1))).intValue() == -1;
    }
    ...
    public int getPlayLevel() {
        int playLevel = ((Integer) SharedPreferenceUtils.get(context, SETTINGS, "PlayLevel", Integer.valueOf(BaseApplication.getInstance().getDefaultLevel()))).intValue();
    ...
    public void setCommentLikeDialog() {
        SharedPreferenceUtils.put(context, SETTINGS, COMMENT_LIKE_DIALOG, Boolean.valueOf(!((Boolean) SharedPreferenceUtils.get(context, SETTINGS, COMMENT_LIKE_DIALOG, Boolean.valueOf(true))).booleanValue()));
    }
    ...
    public boolean isShowCommentRedDot() {
        return ((Boolean) SharedPreferenceUtils.get(context, SETTINGS, COMMENT_GUIDE_RED_DOT, Boolean.valueOf(true))).booleanValue();
    }

    public void setShowCommentRedDot(boolean show) {
        SharedPreferenceUtils.put(context, SETTINGS, COMMENT_GUIDE_RED_DOT, Boolean.valueOf(show));
    }
    ...
    public void setUnreadMessageCount(int count) {
        SharedPreferenceUtils.put(context, PERSONAL_CENTER_SP_NAME, "unread_message", Integer.valueOf(count));
    }

    public int getUnreadMessageCount() {
        return ((Integer) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, "unread_message", Integer.valueOf(0))).intValue();
    }
    ...
    public void setRedPacketIdForStatistics(String rpid) {
        SharedPreferenceUtils.put(context, REDPACKET, "rpid", rpid);
    }
    ...
    public void setSkipAdTipFlag() {
        SharedPreferenceUtils.put(context, PERSONAL_CENTER_SP_NAME, "setSkipAdFlag", Boolean.valueOf(true));
    }

    public boolean getSkipAdTipFlag() {
        return ((Boolean) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, "setSkipAdFlag", Boolean.valueOf(false))).booleanValue();
    }
    ...
    public void setVip(boolean isVip) {
        LetvLogApiTool.getInstance().saveExceptionInfo("是否是会员 Current Time :" + StringUtils.getTimeStamp() + " isVip == " + isVip);
    ...
    public void setVipCancelTime(long cancelTime) {
        LetvLogApiTool.getInstance().saveExceptionInfo("普通会员过期时间 Current Time :" + StringUtils.getTimeStamp() + " cancelTime == " + cancelTime);
    ...
    public void setSeniorVipCancelTime(long cancelTime) {
        LetvLogApiTool.getInstance().saveExceptionInfo("高级会员过期时间 Current Time :" + StringUtils.getTimeStamp() + " cancelTime == " + cancelTime);
    ...
    public void setVipLevel(int vipLevel) {
        LetvLogApiTool.getInstance().saveExceptionInfo("会员级别 Current Time :" + StringUtils.getTimeStamp() + " vipLevel == " + vipLevel);
    ...
    public void setReceiveVipActivityStatus(int status) {
        SharedPreferenceUtils.put(context, PERSONAL_CENTER_SP_NAME, "activity_status", Integer.valueOf(status));
    }

    public int getReceiveVipActivityStatus() {
        return ((Integer) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, "activity_status", Integer.valueOf(-1))).intValue();
    }

    public void setReceiveVipActivityUrl(String url) {
        SharedPreferenceUtils.put(context, PERSONAL_CENTER_SP_NAME, "activity_url", url);
    }
    ...
    public void saveHasVideoShotActionGuide(Boolean isGuide) {
        context.getSharedPreferences(SHARE, 0).edit().putBoolean(HAS_SHOWN_VIDEOSHOT_ACTION_GUIDE, isGuide.booleanValue()).commit();
    }
    ...
    public boolean getUtp() {
        return ((Boolean) SharedPreferenceUtils.get(context, HOME_PAGE, "utp", Boolean.valueOf(true))).booleanValue();
    }

    public void setChinaUnicomSwitch(boolean isOpen) {
        LogInfo.log("联通流量包是否开启 = " + isOpen);
    ...
    public String getDownloadLow_zh() {
        String dn = LetvUtils.getString(R.string.stream_smooth);
    ...
    public String getDownloadNormal_zh() {
        String dn = LetvUtils.getString(R.string.stream_hd);
    ...
    public String getDownloadHigh_zh() {
        String dn = LetvUtils.getString(R.string.stream_shd);
    ...
    public String getPlaySuperSpeed_zh() {
        String dn = LetvUtils.getString(R.string.stream_low);
    ...
    public String getPlayNormal_zh() {
        String dn = LetvUtils.getString(R.string.stream_hd);
        String name = (String) SharedPreferenceUtils.get(context, BR_CONTROL, "normal_play_zh", dn);
        if (TextUtils.isEmpty(name)) {
            return dn;
        }
        return name;
    ...
    public void setContinueDiscount(String userId, String price) {
        if (!TextUtils.isEmpty(userId)) {
            SharedPreferenceUtils.put(context, "", userId + "_continue_discount", price);
        }
    }
    ...
    public String getContinueDiscount(String userId) {
        ...
        return StringUtils.subZeroAndDot((String) SharedPreferenceUtils.get(context, "", userId + "_continue_discount", "0"));
    }

    private void cleanContinueDiscount(String userId) {
        SharedPreferenceUtils.remove(context, "", userId + "_continue_discount");
    }
    ...
    public boolean isShowMiGuDialog() {
        return ((Boolean) SharedPreferenceUtils.get(context, DIALOG_MIGU, "show", Boolean.valueOf(true))).booleanValue();
    }

    public void setShowMiGuDialog(boolean show) {
        SharedPreferenceUtils.put(context, DIALOG_MIGU, "show", Boolean.valueOf(show));
    }

    public boolean isRequestLunboData() {
        return ((Boolean) SharedPreferenceUtils.get(context, LIVE_LUNBO, SocialConstants.TYPE_REQUEST, Boolean.valueOf(false))).booleanValue();
    }

    public void setRequestLunboData(boolean requested) {
        SharedPreferenceUtils.put(context, LIVE_LUNBO, SocialConstants.TYPE_REQUEST, Boolean.valueOf(requested));
    }
    ...
    public void setLocationProvince(String province) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "locationProvince", province);
    }
    ...
    public void setStatisticsLocation(String location) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "statisticsLocation", location);
    }
    ...
    public void setLastCountryCode(String code) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "last_countryCode", code);
    }

    public void setLetvCountryCode(String code) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "letvCountryCode", code);
    }
    ...
    public void setLetvProvinceCode(String code) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "letvProvinceCode", code);
    }
    ...
    public void setLetvDistrictCode(String code) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "letvDistrictCode", code);
    }
    ...
    public void setLetvCityCode(String code) {
        SharedPreferenceUtils.put(context, BD_LOCATION, "letvCityCode", code);
    }
    ...
    public void setPageCardVersion(String pageCardVersion) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "home_page_card_" + LetvUtils.getClientVersionName(), pageCardVersion);
    }
    ...
    public int getCopyright() {
        return ((Integer) SharedPreferenceUtils.get(context, HOME_PAGE, "copyright", Integer.valueOf(0))).intValue();
    }

    public void setCopyright(int copyright) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "copyright", Integer.valueOf(copyright));
    }

    public int getDlna() {
        return ((Integer) SharedPreferenceUtils.get(context, HOME_PAGE, "dlna", Integer.valueOf(1))).intValue();
    }

    public void setDlna(int dlna) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "dlna", Integer.valueOf(dlna));
    }

    public int getHotPatchNo() {
        return ((Integer) SharedPreferenceUtils.get(context, HOTPATCH, "patchNo", Integer.valueOf(0))).intValue();
    }

    public void setHotPatchNo(int patchNo) {
        SharedPreferenceUtils.put(context, HOTPATCH, "patchNo", Integer.valueOf(patchNo));
    }

    public void setDexPatchNo(int dexPatchNo) {
        SharedPreferenceUtils.put(context, HOTPATCH, "dexPatchNo", Integer.valueOf(dexPatchNo));
    }

    public int getDexPatchNo() {
        return ((Integer) SharedPreferenceUtils.get(context, HOTPATCH, "dexPatchNo", Integer.valueOf(0))).intValue();
    }

    public void setDexPatchEnable(boolean enable) {
        SharedPreferenceUtils.put(context, HOTPATCH, "dexPatchEnable", Boolean.valueOf(enable));
    }

    public boolean isDexPatchEnable() {
        return ((Boolean) SharedPreferenceUtils.get(context, HOTPATCH, "dexPatchEnable", Boolean.valueOf(false))).booleanValue();
    }

    public void setLeboxEnable(boolean enable) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "lebox", Boolean.valueOf(enable));
    }

    public boolean isLeboxEnable() {
        return ((Boolean) SharedPreferenceUtils.get(context, HOME_PAGE, "lebox", Boolean.valueOf(false))).booleanValue();
    }
    ...
    public void setRedPackageSDK(String reaPackageSDK) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "reaPackageSDK", reaPackageSDK);
    }

    public int getReactNativeEnable() {
        return ((Integer) SharedPreferenceUtils.get(context, HOME_PAGE, "reactNative", Integer.valueOf(1))).intValue();
    }

    public void setReactNativeEnable(int enable) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "reactNative", Integer.valueOf(enable));
    }

    public int getSwitchStreamEnable() {
        return ((Integer) SharedPreferenceUtils.get(context, HOME_PAGE, "switchStream", Integer.valueOf(1))).intValue();
    }

    public void setSwitchStreamEnable(int enable) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "switchStream", Integer.valueOf(enable));
    }

    public int getSwitchEndlessRecyclerEnable() {
        return ((Integer) SharedPreferenceUtils.get(context, HOME_PAGE, "endlessRecycler", Integer.valueOf(1))).intValue();
    }

    public void setSwitchEndlessRecyclerEnable(int enable) {
        SharedPreferenceUtils.put(context, HOME_PAGE, "endlessRecycler", Integer.valueOf(enable));
    }

    public void setCitySelect(int position) {
        SharedPreferenceUtils.put(context, API, "city_select", Integer.valueOf(position));
    }

    public int getCitySelect() {
        return ((Integer) SharedPreferenceUtils.get(context, API, "city_select", Integer.valueOf(0))).intValue();
    }

    public void setChannelNavigation(String stringJson) {
        SharedPreferenceUtils.put(context, API, "channel_navigation", stringJson);
    }

    public boolean getChannelNavigationChange() {
        return ((Boolean) SharedPreferenceUtils.get(context, API, "channel_navigation_change", Boolean.valueOf(false))).booleanValue();
    }

    public void setChannelNavigationChange(boolean hasChange) {
        SharedPreferenceUtils.put(context, API, "channel_navigation_change", Boolean.valueOf(hasChange));
    }
    ...
    public void setHasShowTeach(boolean hasShow) {
        SharedPreferenceUtils.put(context, API, "has_show_teach", Boolean.valueOf(hasShow));
    }

    public boolean getHasShowTeach() {
        return ((Boolean) SharedPreferenceUtils.get(context, API, "has_show_teach", Boolean.valueOf(false))).booleanValue();
    }

    public void setHasShowUserGuide(boolean hasShow) {
        SharedPreferenceUtils.put(context, API, "has_show_home_guide", Boolean.valueOf(hasShow));
    }

    public boolean getHasShowUserGuide() {
        return ((Boolean) SharedPreferenceUtils.get(context, API, "has_show_home_guide", Boolean.valueOf(false))).booleanValue();
    }

    public long getUpgradeTime() {
        return ((Long) SharedPreferenceUtils.get(context, SETTINGS, UPGRADE_TIMER, Long.valueOf(0))).longValue();
    }

    public void setUpgradeTime(long time) {
        SharedPreferenceUtils.put(context, SETTINGS, UPGRADE_TIMER, Long.valueOf(time));
    }

    public void setNetIp(String ip) {
        SharedPreferenceUtils.put(context, API, "ip", ip);
    }
    ...
    public void setApplyPermissionsSuccess() {
        SharedPreferenceUtils.put(context, SETTINGS, "ApplyPermissionsSuccess_" + LetvUtils.getClientVersionName(), Boolean.valueOf(true));
    }

    public boolean isApplyPermissionsSuccess() {
        return ((Boolean) SharedPreferenceUtils.get(context, SETTINGS, "ApplyPermissionsSuccess_" + LetvUtils.getClientVersionName(), Boolean.valueOf(false))).booleanValue();
    }

    public void setDoubleChannel(boolean doubleChannel) {
        SharedPreferenceUtils.put(context, ORIGINAL_CHANNEL, "double_channel", Boolean.valueOf(doubleChannel));
    }

    public boolean isDoubleChannel() {
        return ((Boolean) SharedPreferenceUtils.get(context, ORIGINAL_CHANNEL, "double_channel", Boolean.valueOf(false))).booleanValue();
    }

    public void setActivieState(boolean activied) {
        SharedPreferenceUtils.put(context, ORIGINAL_CHANNEL, "state", activied ? "on" : "off");
    }
    ...
    public void setOriginalVersion(String version) {
        SharedPreferenceUtils.put(context, ORIGINAL_CHANNEL, "version", version);
    }

    public String getOriginalVersion() {
        return (String) SharedPreferenceUtils.get(context, ORIGINAL_CHANNEL, "version", IdManager.DEFAULT_VERSION_NAME);
    }

    public void setOriginalPcode(String originalPcode) {
        SharedPreferenceUtils.put(context, ORIGINAL_CHANNEL, "original_pcode", originalPcode);
    }
    ...
    public void setOriginalAppkey(String originalAppkey) {
        SharedPreferenceUtils.put(context, ORIGINAL_CHANNEL, "original_appkey", originalAppkey);
    }
    ...
    public void setCardSort(String cardSort) {
        SharedPreferenceUtils.put(context, API, "current_block_sort", cardSort);
    }
    ...
    public void setHasEditCard(boolean hasShow) {
        SharedPreferenceUtils.put(context, API, "has_edit_card", Boolean.valueOf(hasShow));
    }

    public boolean getHasEditCard() {
        return ((Boolean) SharedPreferenceUtils.get(context, API, "has_edit_card", Boolean.valueOf(false))).booleanValue();
    }

    public void setHasShowCardGuide(int showNum) {
        SharedPreferenceUtils.put(context, API, "has_show_card_guide", Integer.valueOf(showNum));
    }

    public int getHasShowCardGuide() {
        return ((Integer) SharedPreferenceUtils.get(context, API, "has_show_card_guide", Integer.valueOf(0))).intValue();
    }

    public String getPluginVersion(String name) {
        return (String) SharedPreferenceUtils.get(context, "plugin", name + EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR + LetvUtils.getClientVersionName(), "0");
    }

    public void setPluginVersion(String name, String version) {
        SharedPreferenceUtils.put(context, "plugin", name + EventsFilesManager.ROLL_OVER_FILE_NAME_SEPARATOR + LetvUtils.getClientVersionName(), version);
    }

    public void setSearchWordsInfo(SearchWordsInfo searchWordsInfo) {
        if (searchWordsInfo != null) {
            SharedPreferenceUtils.put(context, SEARCH_WORDS, "search_type", TextUtils.isEmpty(searchWordsInfo.mType) ? "2" : searchWordsInfo.mType);
            SharedPreferenceUtils.put(context, SEARCH_WORDS, "search_title", TextUtils.isEmpty(searchWordsInfo.mTitle) ? "" : searchWordsInfo.mTitle);
    ...
    public String[] getSearchWordsInfo() {
        return new String[]{(String) SharedPreferenceUtils.get(context, SEARCH_WORDS, "search_type", "2"), (String) SharedPreferenceUtils.get(context, SEARCH_WORDS, "search_title", ""), (String) SharedPreferenceUtils.get(context, SEARCH_WORDS, "search_pic_type", "1")};
    }

    public void setLoadingBackground(String key, String value) {
        SharedPreferenceUtils.put(context, PERSONAL_CENTER_SP_NAME, key, value);
    }

    public boolean loadingPicNotSaved(String vid, String pid) {
        String urlUseVid = (String) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, vid + "", "");
        if (TextUtils.isEmpty(urlUseVid)) {
            String urlUsePid = (String) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, pid + "", "");
            if (TextUtils.isEmpty(urlUsePid)) {
                return false;
            }
            if (ImageDownloader.getInstance().isBitmapExistInDisk(urlUsePid)) {
                return true;
            }
            ImageDownloader.getInstance().download(urlUsePid);
            return true;
        } else if (ImageDownloader.getInstance().isBitmapExistInDisk(urlUseVid)) {
            return true;
        } else {
            ImageDownloader.getInstance().download(urlUseVid);
            return true;
        }
    }

    public String getLoadingBackground(String vid, String pid) {
        String urlUseVid = (String) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, vid + "", "");
        LogInfo.log("zhaosumin", "getLoadingBackground == " + urlUseVid + " isExit = " + ImageDownloader.getInstance().isBitmapExistInDisk(urlUseVid));
        if (!TextUtils.isEmpty(urlUseVid) && ImageDownloader.getInstance().isBitmapExistInDisk(urlUseVid)) {
            return urlUseVid;
        }
        String urlUsePid = (String) SharedPreferenceUtils.get(context, PERSONAL_CENTER_SP_NAME, pid + "", "");
        LogInfo.log("zhaosumin", "getLoadingBackground == " + urlUsePid + " isExit = " + ImageDownloader.getInstance().isBitmapExistInDisk(urlUsePid));
        if (TextUtils.isEmpty(urlUsePid) || !ImageDownloader.getInstance().isBitmapExistInDisk(urlUsePid)) {
            return TipUtils.getTipMessage("100121");
        }
        return urlUsePid;
    }

    public int getProtoBuf() {
        return ((Integer) SharedPreferenceUtils.get(context, SETTINGS, "protobuf", Integer.valueOf(0))).intValue();
    }

    public boolean getBooleanProtoBuf() {
        return getProtoBuf() == 1;
    }

    public void setProtoBuf(int protobuf) {
        SharedPreferenceUtils.put(context, SETTINGS, "protobuf", Integer.valueOf(protobuf));
    }
}
