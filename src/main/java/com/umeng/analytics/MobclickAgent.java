...
public class MobclickAgent {
    ...
    public static void onPageStart(String str) {
        if (TextUtils.isEmpty(str)) {
            bv.f("pageName is null or empty");
        } else {
            b.a(str);
        }
    }
    ...
    public static void onResume(Context context) {
        if (context == null) {
            bv.f("unexpected null context in onResume");
        } else {
            b.a(context);
        }
    }
    ...
    public static void onResume(Context context, String str, String str2) {
        if (context == null) {
            ...
            bv.f("unexpected empty appkey in onResume");
        } else {
    ...
    public static void onEventDuration(Context context, String str, long j) {
        if (j <= 0) {
            bv.d("duration is not valid in onEventDuration");
        } else {
    ...
    public static void onSocialEvent(Context context, String str, UMPlatformData... uMPlatformDataArr) {
        if (context == null) {
            bv.f("context is null in onShareEvent");
            return;
        }
        e.e = "3";
    ...
    public static void onProfileSignIn(String str, String str2) {
        if (TextUtils.isEmpty(str2)) {
            ...
            bv.e("uid is Illegal(length bigger then  legitimate length).");
        } else if (TextUtils.isEmpty(str)) {
            b.b("_adhoc", str2);
        } else if (str.length() > 32) {
            bv.e("provider is Illegal(length bigger then  legitimate length).");
        } else {
            b.b(str, str2);
        }
    }
